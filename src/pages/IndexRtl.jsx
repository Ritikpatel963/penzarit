            ...
            <div className="row rg-30">
              ...
              <div className="col-lg-6 order-lg-2 order-1">
                <div className="about-content-area tj-fade-anim" data-delay=".1" data-direction="right">
                  ...
                  <a className="tj-primary-btn style-2 mt-25" href="about.html">
                    <span className="btn-text"><span>تعرف أكثر</span></span>
                    <span className="btn-icon"><i className="tji-arrow-right-2"></i></span>
                  </a>
                ...
                <div className="service-item tj-fade-anim" data-delay="0.3" data-direction="bottom">
                  <div className="service-inner">
                    ...
                    <div className="service-content">
                      <h4 className="title"><a href="service-details.html">خدمات IT مُدارة</a></h4>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-item tj-fade-anim" data-delay="0.5" data-direction="bottom">
                  <div className="service-inner">
                    ...
                    <div className="service-content">
                      <h4 className="title"><a href="service-details.html">الحوسبة السحابية</a></h4>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-item tj-fade-anim" data-delay="0.1" data-direction="bottom">
                  <div className="service-inner">
                    ...
                    <div className="service-content">
                      <h4 className="title"><a href="service-details.html">حلول الأمن السيبراني</a></h4>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-item tj-fade-anim" data-delay="0.3" data-direction="bottom">
                  <div className="service-inner">
                    ...
                    <div className="service-content">
                      <h4 className="title"><a href="service-details.html">استشارات واستراتيجية IT</a></h4>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-item tj-fade-anim" data-delay="0.5" data-direction="bottom">
                  <div className="service-inner">
                    ...
                    <div className="service-content">
                      <h4 className="title"><a href="service-details.html">البنية التحتية للشبكات</a></h4>
                      <p className="desc">إرشادات خبراء لتحسين بنية IT، تبسيط العمليات، وتعزيز الأداء.</p>
                    </div>
                    <div className="service-list">
                      <ul className="list-style-2">
            ...
            <div className="row rg-30">
              <div className="col-lg-3 col-sm-6">
                <div className="team-item img-reveal-2">
                  ...
                  <div className="team-content">
                    <h4 className="title"><a href="team-details.html">إيد مارين</a></h4>
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="team-item img-reveal-2">
                  ...
                  <div className="team-content">
                    <h4 className="title"><a href="team-details.html">سافانا نغوين</a></h4>
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="team-item img-reveal-2">
                  ...
                  <div className="team-content">
                    <h4 className="title"><a href="team-details.html">كاميرون ويليام</a></h4>
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="team-item img-reveal-2">
                  ...
                  <div className="team-content">
                    <h4 className="title"><a href="team-details.html">أوليفيا فوكس</a></h4>
                        ...
                        <div className="project-item">
                          ...
                          <div className="project-content">
                            <div className="content-inner">
                              <span className="categories"><a href="project-details.html">حلول</a></span>
                              <h4 className="title"><a href="project-details.html">تحويل الأعمال</a></h4>
                            </div>
                      ...
                      <div className="swiper-slide">
                        <div className="project-item">
                          ...
                          <div className="project-content">
                            <div className="content-inner">
                              <span className="categories"><a href="project-details.html">حلول</a></span>
                              <h4 className="title"><a href="project-details.html">نجاح الهجرة السحابية</a></h4>
                            </div>
                            <a className="tj-icon-btn" href="project-details.html">
                              <i className="tji-arrow-right-3"></i>
                            </a>
                      ...
                      <div className="swiper-slide">
                        <div className="project-item">
                          ...
                          <div className="project-content">
                            <div className="content-inner">
                              <span className="categories"><a href="project-details.html">حلول</a></span>
                              <h4 className="title"><a href="project-details.html">استراتيجية النمو الرقمي</a></h4>
                            </div>
                            <a className="tj-icon-btn" href="project-details.html">
                              <i className="tji-arrow-right-3"></i>
                            </a>
                      ...
                      <div className="swiper-slide">
                        <div className="project-item">
                          ...
                          <div className="project-content">
                            <div className="content-inner">
                              <span className="categories"><a href="project-details.html">حلول</a></span>
                              <h4 className="title"><a href="project-details.html">تطوير تطبيقات الجوال</a></h4>
                            </div>
                            <a className="tj-icon-btn" href="project-details.html">
                              <i className="tji-arrow-right-3"></i>
                            </a>
            ...
            <div className="row rg-30">
              <div className="col-lg-4 col-md-6">
                <div className="blog-item tj-fade-anim" data-delay="0.1">
                  <div className="blog-thumb img-reveal-2">
                    <a href="blog-details.html"><img src="assets/images/blog/blog-1.webp" alt="صورة المقال" /></a>
                  ...
                  <div className="blog-content">
                    <div className="blog-meta">
                      <span className="categories"><a href="blog-details.html">حلول</a></span>
                      <span>بواسطة <a href="blog-details.html">إلينين لوما</a></span>
                    </div>
                    <h4 className="title"><a href="blog-details.html">كيفية نقل عملك بنجاح إلى السحابة</a></h4>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="blog-item tj-fade-anim" data-delay="0.2">
                  <div className="blog-thumb img-reveal-2">
                    <a href="blog-details.html"><img src="assets/images/blog/blog-2.webp" alt="صورة المقال" /></a>
                    <div className="blog-date">
                      <span className="date">28</span>
                      <span className="month">فبراير</span>
                    </div>
                  ...
                  <div className="blog-content">
                    <div className="blog-meta">
                      <span className="categories"><a href="blog-details.html">تركيز</a></span>
                      <span>بواسطة <a href="blog-details.html">إلينين لوما</a></span>
                    </div>
                    <h4 className="title"><a href="blog-details.html">بناء قوة عاملة أقوى من خلال التدريب على تكنولوجيا
                        المعلومات</a></h4>
                    <a className="tj-text-btn" href="blog-details.html">
                      <span className="btn-inner">
                        <span className="btn-icon"><span><i className="tji-arrow-right-4"></i></span></span>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="blog-item tj-fade-anim" data-delay="0.3">
                  <div className="blog-thumb img-reveal-2">
                    <a href="blog-details.html"><img src="assets/images/blog/blog-3.webp" alt="صورة المقال" /></a>
                    <div className="blog-date">
                      <span className="date">28</span>
                      <span className="month">فبراير</span>
                    </div>
                  ...
                  <div className="blog-content">
                    <div className="blog-meta">
                      <span className="categories"><a href="blog-details.html">البرمجيات</a></span>
                      <span>بواسطة <a href="blog-details.html">إلينين لوما</a></span>
                    </div>
                    <h4 className="title"><a href="blog-details.html">تحسين ميزانية تكنولوجيا المعلومات: نصائح
                        واستراتيجيات</a></h4>
                    <a className="tj-text-btn" href="blog-details.html">
                      <span className="btn-inner">
                        <span className="btn-icon"><span><i className="tji-arrow-right-4"></i></span></span>
