                  ...
                  <div className="tj-post__navigation mb-0">
                    ...
                    <div className="tj-nav__post previous">
                      <div className="tj-nav-post__nav prev_post">
                        <a href="service-details.html"><span><i className="tji-arrow-left-5"></i></span>Previous</a>
                      </div>
                    </div>
                    <div className="tj-nav-post__grid">
                      <a href="service.html"><i className="tji-window"></i></a>
                    </div>
                    {/*  next post  */}
                    <div className="tj-nav__post next">
                      <div className="tj-nav-post__nav next_post">
                        <a href="service-details.html">Next<span><i className="tji-arrow-right-5"></i></span></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-4">
                <div className="tj-main-sidebar">
                  <div className="tj-sidebar-widget service-categories">
                    ...
                    <ul>
                      <li>
                        <a href="service-details.html">Manage IT Service<span className="icon"><i
                              className="tji-arrow-right-5"></i></span></a>
                      </li>
                      <li>
                        <a className="active" href="service-details.html">Cloud Computing<span className="icon"><i
                              className="tji-arrow-right-5"></i></span></a>
                      </li>
                      <li>
                        <a href="service-details.html">Cyber Security<span className="icon"><i
                              className="tji-arrow-right-5"></i></span></a>
                      </li>
                      <li>
                        <a href="service-details.html">Software Develop<span className="icon"><i
                              className="tji-arrow-right-5"></i></span></a>
                      </li>
                      <li>
                        <a href="service-details.html">Change Manage<span className="icon"><i
                              className="tji-arrow-right-5"></i></span></a>
                      </li>
                      <li>
                        <a href="service-details.html">IT Consulting<span className="icon"><i
                              className="tji-arrow-right-5"></i></span></a>
                      </li>
                    </ul>
                  </div>
