  ...
  return (
    <>
        ...
        <section className="tj-banner-section h5-banner-section fix">
          <div className="hero-bg" data-bg-image="assets/images/bg/common-bg-3.webp"></div>
              ...
              <div className="col-xxl-6 col-lg-7">
                <div className="banner-img-area">
                  <div className="banner-img tj-fade-anim" data-delay="0.3" data-direction="bottom">
                    <img src="assets/images/hero/h5-hero-img.webp" alt="Image" />
                  </div>
                  <div className="banner-img-2 tj-fade-anim" data-delay="0.3" data-direction="top">
                    <img src="assets/images/hero/h5-hero-img-2.webp" alt="Image" />
                  </div>
                  <div className="box-item-wrap">
                    ...
                    <div className="box-item box-item-2 tj-fade-anim" data-delay="0.9" data-direction="left">
                      ...
                      <img src="assets/images/hero/line-2.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="blur-shape-wrap">
            <div className="blur-shape">
              <img src="assets/images/shapes/h5-blur-1.png" alt="" />
            </div>
            <div className="blur-shape blur-shape-2">
              <img src="assets/images/shapes/h5-blur-2.png" alt="" />
            </div>
          </div>
        </section>
        {/*  end: Banner Section  */}
                  ...
                  <div className="scroll-slider">
                    <div className="scroll-wrapper">
                      <div className="client-logo">
                        <img src="assets/images/brands/h5-brand-1.png" alt="Image" />
                      </div>
                      <div className="client-logo">
                        <img src="assets/images/brands/h5-brand-2.png" alt="Image" />
                      </div>
                      <div className="client-logo">
                        <img src="assets/images/brands/h5-brand-3.png" alt="Image" />
                      </div>
                      <div className="client-logo">
                        <img src="assets/images/brands/h5-brand-4.png" alt="Image" />
                      </div>
                      <div className="client-logo">
                        <img src="assets/images/brands/h5-brand-5.png" alt="Image" />
                      </div>
                      <div className="client-logo">
                        <img src="assets/images/brands/h5-brand-6.png" alt="Image" />
                      </div>
                      <div className="client-logo">
                        <img src="assets/images/brands/h5-brand-1.png" alt="Image" />
                      </div>
                ...
                <div className="sec-heading style-3">
                  ...
                  <div className="sec-heading-inner">
                    ...
                    <div className="tj-fade-anim" data-delay="0.3">
                      <a className="tj-primary-btn d-none d-lg-inline-flex" href="service.html">
                        ...
                        <div className="service-item service-item-4">
                          <div className="service-inner">
                            ...
                            <div className="service-content">
                              ...
                              <p className="desc">Comprehensive IT management, including monitoring, maintenance, and
                                support to keep your business running smoothly.</p>
                            </div>
                          </div>
                        ...
                        <div className="service-item service-item-4">
                          <div className="service-inner">
                            ...
                            <div className="service-content">
                              ...
                              <p className="desc">Scalable cloud-based services, including migration, storage, and security,
                                for enhanced flexibility and efficiency.</p>
                            </div>
                          </div>
                        ...
                        <div className="service-item service-item-4">
                          <div className="service-inner">
                            ...
                            <div className="service-content">
                              ...
                              <p className="desc">Advanced security measures, including firewall protection, threat
                                detection, and compliance solutions, to safeguard your business.</p>
                            </div>
                          </div>
                      ...
                      <div className="swiper-slide">
                        <div className="service-item service-item-4">
                          <div className="service-inner">
                            ...
                            <div className="service-content">
                              <h4 className="title"><a href="service-details.html">Software Development</a></h4>
                              <p className="desc">Custom software solutions tailored to your business needs, including web
          ...
          <div className="secure-wrap">
            <div className="secure-item">
              <div className="secure-img-wrap tj-fade-anim" data-direction="left"
                data-bg-image="assets/images/secure/secure-bg-1.webp">
                <div className="secure-img" data-tilt>
                  <div className="img-reveal-2">
                    <img src="assets/images/secure/secure-img-1.webp" alt="" />
                  </div>
                </div>
              </div>
              <div className="secure-content">
                ...
                <div className="tj-fade-anim" data-delay="0.7">
                  <a className="tj-primary-btn mt-30" href="about.html">
                    <span className="btn-text"><span>Learn More</span></span>
                    <span className="btn-icon"><i className="tji-arrow-right-2"></i></span>
                  </a>
                </div>
            ...
            <div className="secure-item">
              <div className="secure-img-wrap tj-fade-anim" data-direction="right"
                data-bg-image="assets/images/secure/secure-bg-2.webp">
                <div className="secure-img" data-tilt>
                  <div className="img-reveal-2">
                    <img src="assets/images/secure/secure-img-2.webp" alt="" />
                  </div>
                </div>
              </div>
              <div className="secure-content">
                  ...
                  <div className="pricing-wrapper">
                    ...
                    <div className="pricing-box">
                      <div className="pricing-header">
                        ...
                        <a className="tj-primary-btn pricing-btn" href="contact.html">
        ...
        <div className="h5-technologies-section section-gap section-gap-x fix">
          <div className="bg-img" data-bg-image="assets/images/bg/common-bg-3.webp"></div>
        ...
        <section className="h5-faq-section section-gap fix">
              ...
              <div className="col-12">
                <div className="sec-heading style-3">
                  ...
                  <div className="sec-heading-inner">
                    ...
                    <div className="tj-fade-anim">
                      <a className="tj-primary-btn" href="faq.html">
          ...
          <div className="shape-wrap">
            <div className="shape tj-fade-anim" data-direction="left">
              <img src="assets/images/shapes/faq-shap-1.svg" alt="" />
            </div>
            <div className="shape shape-2 tj-fade-anim" data-direction="right">
              <img src="assets/images/shapes/faq-shap-2.svg" alt="" />
            </div>
          </div>
        </section>
        {/*  end: FAQ Section  */}
