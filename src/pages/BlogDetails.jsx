                  ...
                  <div className="tj-post__navigation">
                    ...
                    <div className="tj-nav__post previous">
                      <div className="tj-nav-post__nav prev_post">
                        <a href="blog-details.html"><span><i className="tji-arrow-left-5"></i></span>Previous</a>
                      </div>
                    </div>
                    ...
                    <div className="tj-nav__post next">
                      <div className="tj-nav-post__nav next_post">
                        <a href="blog-details.html">Next<span><i className="tji-arrow-right-5"></i></span></a>
                      </div>
                    </div>
                  </div>
                            ...
                            <div className="comment-content">
                              ...
                              <div className="comments-header">
                                <div className="avatar-name">
                                  <h6 className="title">
                                    <a href="blog-details.html">Owen Parker</a>
                                  </h6>
                                </div>
                                <div className="comment-text">
                                  <span className="date">June 18, 2024 at 06:00 pm</span>
                                  <a className="comment-reply-link" href="blog-details.html">Reply</a>
                                </div>
                                <div className="desc">
                                  <p>
                          ...
                          <li className="tj-comment">
                            <div className="comment-content">
                              ...
                              <div className="comments-header">
                                <div className="avatar-name">
                                  <h6 className="title">
                                    <a href="blog-details.html">Hunter James</a>
                                  </h6>
                                </div>
                                <div className="comment-text">
                                  <span className="date">June 18, 2024 at 06:00 pm</span>
