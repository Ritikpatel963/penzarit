                ...
                <div className="sec-heading style-2">
                  ...
                  <div className="sec-heading-inner">
                    ...
                    <div className="tj-fade-anim d-lg-inline-flex d-none" data-delay="0.1">
                      <a className="tj-primary-btn mt-20" href="services.html">
                        <span className="btn-text"><span>Explore More</span></span>
                        <span className="btn-icon"><i className="tji-arrow-right-2"></i></span>
                      </a>
                    </div>
              ...
              <div className="col-lg-4">
                <div className="sec-heading style-2 tj-sticky-item">
                  ...
                  <div className="tj-fade-anim" data-delay="0.5">
                    <a className="tj-primary-btn" href="portfolio.html">
                      <span className="btn-text"><span>Explore More</span></span>
                      <span className="btn-icon"><i className="tji-arrow-right-2"></i></span>
                    </a>
                  </div>
                ...
                <div className="project-wrapper project-wrapper-2">
                  <div className="project-item tj-fade-anim">
                    <div className="project-img img-reveal-2">
                      <a href="project-details.html"> <img src="assets/images/project/project-3.webp" alt="" /></a>
                    </div>
                    <div className="project-content">
                      <div className="content-inner">
                        <span className="categories"><a href="project-details.html">Information</a></span>
                        <h3 className="title"><a href="project-details.html">Digital Growth Strategy</a></h3>
                  ...
                  <div className="project-item tj-fade-anim">
                    <div className="project-img img-reveal-2">
                      <a href="project-details.html"> <img src="assets/images/project/project-2.webp" alt="" /></a>
                    </div>
                    <div className="project-content">
                      <div className="content-inner">
                        <span className="categories"><a href="project-details.html">Solution</a></span>
                        <h3 className="title"><a href="project-details.html">Cloud Migration System</a></h3>
                  ...
                  <div className="project-item tj-fade-anim">
                    ...
                    <div className="project-content">
                      <div className="content-inner">
                        <span className="categories"><a href="project-details.html">Solution</a></span>
                        <h3 className="title"><a href="project-details.html">Mobile App Development</a></h3>
                        <p className="desc">A strong mobile presence is crucial for business growth in today’s digital age.
                          We design and develop custom mobile applications for iOS.</p>
                      </div>
                      <a className="tj-icon-btn" href="project-details.html">
