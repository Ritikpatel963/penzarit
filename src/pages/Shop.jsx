                  ...
                  <div className="row rg-30 row-cols-xl-2 row-cols-lg-2 row-cols-md-2 row-cols-1">
                    ...
                    <div className="tj-product">
                      <div className="tj-product-item">
                        ...
                        <div className="tj-product-content">
                          ...
                          <h3 className="tj-product-title">
                            <a href="shop-details.html">Base Booster Speaker</a>
                          </h3>
                    ...
                    <div className="tj-product">
                      <div className="tj-product-item">
                        <div className="tj-product-thumb">
                          <a href="shop-details.html">
                            <img src="./assets/images/product/product-3.webp" alt="" /> </a>
                        ...
                        <div className="tj-product-content">
                          <div className="tj-product-tag d-none">
                            <a href="hshop-details.html"> Speaker</a>
                          </div>
                          <h3 className="tj-product-title">
                            <a href="shop-details.html">Power Link Charging Cable</a>
                          </h3>
                    ...
                    <div className="tj-product">
                      <div className="tj-product-item">
                        ...
                        <div className="tj-product-content">
                          ...
                          <h3 className="tj-product-title">
                            <a href="shop-details.html">Pure White Slim Cover</a>
                          </h3>
                    ...
                    <div className="tj-product">
                      <div className="tj-product-item">
                        ...
                        <div className="tj-product-content">
                          <div className="tj-product-tag d-none">
                            <a href="shop-details.html"> Cover</a>
                          </div>
                          <h3 className="tj-product-title">
                            <a href="shop-details.html">Turbo Volt Wall Charger</a>
                          </h3>
                    ...
                    <div className="tj-product">
                      <div className="tj-product-item">
                        ...
                        <div className="tj-product-content">
                          ...
                          <h3 className="tj-product-title">
                            <a href="shop-details.html">Travel MultiFunctional Charger</a>
                          </h3>
                ...
                <div className="tj-shop-sidebar slidebar-stickiy">
                  ...
                  <div className="product-widget  widget_product_categories">
                    ...
                    <ul className="product-categories">
                      ...
                      <li><a href="shop-details.html">Charger</a> <span className="count">(2)</span></li>
                      <li><a href="shop-details.html">Cover</a> <span>(1)</span></li>
                      <li><a href="shop-details.html">Power</a> <span className="count">(2)</span></li>
                          ...
                          <div className="post-image">
                            <a href="shop-details.html">
                              <img width="300" height="300" src="./assets/images/product/product-3.webp"
                                className="attachment-_thumbnail size-_thumbnail" alt="Base booster speaker" /> </a>
                          </div>
                  ...
                  <div className="product-widget  widget_product_tag_cloud">
                    ...
                    <div className="tagcloud"><a href="shop-details.html">Compact</a>
                      <a href="shop-details.html">Durable</a>
                      <a href="shop-details.html">Fast</a>
                      <a href="shop-details.html" className="tag-cloud-link">Portable</a>
                      <a href="shop-details.html" className="tag-cloud-link ">Powerful</a>
                      <a href="shop-details.html" className="tag-cloud-link ">Reliable</a>
                      <a href="shop-details.html" className="tag-cloud-link ">Retiable</a>
                    </div>
                  </div>
                </div>
              </div>
