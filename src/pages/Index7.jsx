              ...
              <div className="customers-box-body">
                <div className="blog-content">
                  <div className="blog-meta">
                    <span className="categories"><a href="blog-details.html">Solutions</a>
                  </div>
                  <h2 className="title">
                    <a href="blog-details.html">Building a Stronger Software for IT</a>
                  </h2>
        ...
        <section className="tj-project-section-3 section-gap fix section-separator">
          ...
          <div className="container-fluid px-0">
            <div className="row">
                  ...
                  <div className="project-item hover-active-item">
                    ...
                    <div className="project-content">
                      <div className="content-inner">
                        ...
                        <h4 className="title"><a href="project-details.html">Business Transformation</a></h4>
                      </div>
              ...
              <div className="col-12">
                <div className="project-more tj-fade-anim" data-delay="0.1"><a className="tj-primary-btn" href="project.html">
                ...
                <div className="blog-item-wrapper">
                  <div className="blog-item blog-item-2 tj-fade-anim" data-delay="0.1">
                    ...
                    <div className="blog-content">
                      ...
                      <h4 className="title"><a href="blog-details.html">Building a Stronger Workforce with IT Training</a>
                      </h4>
                  ...
                  <div className="blog-item blog-item-2 tj-fade-anim" data-delay="0.3">
                    ...
                    <div className="blog-content">
                      ...
                      <h4 className="title"><a href="blog-details.html">The Top 5 IT Challenges Faced by Modern
                          Enterprises</a>
                      </h4>
                      <a className="tj-text-btn" href="blog-details.html">
                        <span className="btn-inner">
