    ...
    <>
                  ...
                  <div className="service-item service-item-8 tj-fade-anim" data-delay=".2" data-direction="bottom">
                    <div className="service-inner">
                      ...
                      <div className="desc-wrap">
                        ...
                        <a className="tj-icon-btn d-lg-none" href="service-details.html">
                          <i className="tji-arrow-bold-right"></i>
                        </a>
                      </div>
                      <a className="tj-icon-btn d-none d-lg-flex" href="service-details.html">
                        <i className="tji-arrow-bold-right"></i>
                      </a>
                    </div>
                  </div>
        ...
        <section className="tj-project-section h8-projcet section-gap section-gap-x">
          ...
          <div className="h8-project-more">
            <a className="tj-primary-btn" href="project.html">
              <span className="btn-text"><span>Explore More</span></span>
              <span className="btn-icon"><i className="tji-arrow-right-2"></i></span>
            </a>
          </div>
                      ...
                      <div className="swiper-slide">
                        <div className="blog-item h8-blog-item">
                          ...
                          <div className="blog-content">
                            ...
                            <h4 className="title"><a href="blog-details.html">How to Successfully Migrate Your Business to
                                the Cloud</a></h4>
                      ...
                      <div className="swiper-slide">
                        <div className="blog-item h8-blog-item">
                          ...
                          <div className="blog-content">
                            ...
                            <h4 className="title"><a href="blog-details.html">Building a Stronger Workforce with IT
                                Training</a></h4>
                            <a className="tj-text-btn" href="blog-details.html">
                              <span className="btn-inner">
                                <span className="btn-icon"><span><i className="tji-arrow-right-4"></i></span></span>
                      ...
                      <div className="swiper-slide">
                        <div className="blog-item h8-blog-item">
                          ...
                          <div className="blog-content">
                            ...
                            <h4 className="title"><a href="blog-details.html">Optimizing Your IT Budget: Tips and
                                Strategies</a></h4>
                            <a className="tj-text-btn" href="blog-details.html">
                              <span className="btn-inner">
                                <span className="btn-icon"><span><i className="tji-arrow-right-4"></i></span></span>
